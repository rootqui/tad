...
namespace Lab_DataAdapter
{
    public partial class FrmStoreProcedure : Form
    {
        ...
        // Instancia de la clase SqlDataAdapter
        SqlDataAdapter objAdaptador = new SqlDataAdapter();

        //Crear un objeto del DataSet
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //objAdaptador.InsertCommand.Parameters.AddWithValue("@PROD_NOMBRE", "PROD_NOMBRE");
                ...
                // El objDataSet, se le asigna el nombre "prod"  y se agrega al objAdaptador.
