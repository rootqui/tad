...
{
    public partial class FrmReceta_TransacionLocal : Form
    {
        SqlConnection con = new SqlConnection();
        SqlCommand cmd = new SqlCommand();
        SqlDataReader loDataReader;

        public FrmReceta_TransacionLocal()
        {
            InitializeComponent();
        }
        ...
        private void BtnNuevo_Click(object sender, EventArgs e)
        {
            ...
            // Crea una instancia de SqlTransaction para las transacciones locales
            SqlTransaction objTransaccion = con.BeginTransaction();
            try
            {
                ...
                // Se agrega el objTransaccion a la propiedad de Transaction del objeto cmd que es una instancia SqlCommand
                ...
                // Si todo se ejecuta sin errores se ejecuta un Commit
            ...
            {
                // Si algo salio mal se ejecuta el metodo Rollback
        ...
        private void FrmPregunta1_Load(object sender, EventArgs e)
        {
            try
            {
                con.ConnectionString = "Server=.;DataBase=P2_PC1_TAD_2019II;Integrated Security=SSPI;";
